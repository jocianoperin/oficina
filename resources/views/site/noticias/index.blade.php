...
<div id="page-wrapper">
                ...
                <div class="row">
                    @foreach($noticias as $noticia)
                        <div class="card md-4 shadow-sm">
                            <h3 style="margin-bottom: 0;">{{$noticia->NotTitulo}}</h3>
                            ...
                            <div class="card-body">
                                <p style="margin-top:5%;"
                                   class="card-text">{{substr(strip_tags($noticia->NotTexto), 0, 250)}}</p>
                                <div class="d-flex justify-content-between align-items-center">
                                    <div style="width:100% !important;" class="btn-group">
                                        ...
                                        <a style='width:100% !important; border-radius:0; border:none; color:#000; background-color:#eac320;'
                                           href='{{url('noticia?id='.$noticia->NotCodigo)}}' class='btn btn-md btn-primary'>Ler Mais..</a>
    ...
    <div style="margin-top:5%;" class="panel-footer">
